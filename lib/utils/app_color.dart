...
class AppColor {
  static const Color dark1blue=  Color(0xFF111827);
  static const Color greysmall=Color(0xFFD1D5DB);
  static const Color greylight=Color(0xFF9CA3AF);
  static const Color deepblue=  Color(0xFF1F2937);
  // ignore: deprecated_member_use
  static Color lightwhite = Colors.white.withOpacity(0.2);
  static const Color lightpink = Color(0xFFF9A8D4);
  static const Color lightorange = Color(0xFFC084FC);
  static const Color light1blue = Color(0xFF818CF8);
  ...
  static const Color clrSmallText = Color(0xFF706E6E);
